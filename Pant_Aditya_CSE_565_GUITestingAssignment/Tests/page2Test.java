    ...
    System.setProperty("webdriver.chrome.driver", "C:\\Users\\aditp\\Documents\\lib\\selenium\\chromedriver-win64\\chromedriver.exe");
        ...
        // ---------------------------------
         ...
         if (image.isDisplayed()) {
             ...
             System.out.println("Image does not exist on the page.");
         }
         ...
         if (radioInput1.isDisplayed() && radioInput2.isDisplayed() && radioInput3.isDisplayed()) {
             ...
             System.out.println("Radio inputs do not exist on the page.");
         }
 
         // Check if slider exists (assuming slider is present and visible)
         ...
         if (slider.isDisplayed()) {
             ...
             System.out.println("Slider does not exist on the page.");
         }
        ...
        // ------------Element Content-----------------
        // --------------------------------------------
        // Check for the content "Meaning of this Word"
        ...
        if (actualButtonText.equals(expectedButtonText)) {
            ...
            System.out.println("Content 'Next' on the button is incorrect.");
        }
        ...
        if (isSliderBelowRadioInputs) {
            ...
            System.out.println("Slider is not below the radio inputs.");
        }
        ...
        if (reachedResultPage) {
            ...
            System.out.println("Error: Could not reach the result page after " + maxIterations + " iterations.");
        }
