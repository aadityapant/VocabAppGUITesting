...
public class page3Test {
    public static void main(String[] args) {
      System.setProperty("webdriver.chrome.driver", "C:\\Users\\aditp\\Documents\\lib\\selenium\\chromedriver-win64\\chromedriver.exe");
        ...
        driver.get("http://127.0.0.1:5500/version_1/index.html");
        ...
        if (reachedResultPage) {
            ...
            if (image.isDisplayed()) {
                ...
                System.out.println("Image does not exist on the result page.");
            }
            ...
            if (slider.isDisplayed()) {
                ...
                System.out.println("Slider does not exist on the result page.");
            }
            ...
            if (checkbox.isDisplayed()) {
                ...
                System.out.println("Checkbox does not exist on the result page.");
            }
            ...
            if (resultButton.isDisplayed()) {
                ...
                System.out.println("Button does not exist on the result page.");
            }
          ...
          if (isSliderBelowCheckbox) {
              ...
              System.out.println("Slider is not below the checkbox.");
          }
          ...
          if (isButtonBelowSlider) {
              ...
              System.out.println("Button is not below the slider.");
          }
        ...
        if (actualCheckboxLabelText.equals(expectedCheckboxLabelText)) {
            ...
            System.out.println("Content of Checkbox Label is incorrect.");
        }
        ...
        if (actualSliderLabelText.equals(expectedSliderLabelText)) {
            ...
            System.out.println("Content of Slider Label is incorrect.");
        }
        ...
        try {
            ...
            System.out.println("Button does not exist on the page.");
        }
        button4.click();
        ...
        if (actualTitle.equals(expectedTitle)) {
            ...
            System.out.println("Title verification failed. The title of the new page is incorrect. The link to the new page is NOT working.");
        }
        } else {
